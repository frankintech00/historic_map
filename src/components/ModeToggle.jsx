/**
 * ModeToggle.jsx — Leaflet-styled toggle switch at bottom-left.
 * Positioned to sit to the right of the zoom control.
 */
import React from "react";

export default function ModeToggle({ split, onToggle }) {
  const handleKey = (e) => {
  ...
  return (
    <div className="absolute bottom-4 left-16 md:left-20 z-[1000] pointer-events-auto">
